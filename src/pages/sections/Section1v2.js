...
function Section1v2({ scrollByVH }) {
  ...
  return (
    <React.Fragment>
      <div
        className={`lg:hidden pt-12 flex flex-row w-screen ${
          isOpen && "shadow-lg"
      ...
      >
        ...
        <div
          className={`w-screen divide-y divide-gray-600 ${
            isOpen
              ? "h-auto overflow-hidden z-60"
              : "hidden h-0 overflow-hidden"
          } transition-all ease-in-out duration-300 w-5/6 bg-black`}
        >
          <div
            className={`w-5/6 flex flex-col font-poppins absolute ${
              isOpen ? "z-70 h-[50%]" : "-z-20"
          ...
          >
            ...
            <div className="flex flex-row space-x-8 pb-8">
              ...
              >
                <SiGmail size={24} className=" text-white hover:text-white" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div className="w-screen flex flex-col items-center">
        <div className="lg:hidden flex flex-row w-full text-[#3c4043] font-poppins font-semibold justify-between"></div>
      ...
      <div
        className={`flex flex-row space-x-8 lg:hidden  w-full justify-center ${
      ...
      <div className="hidden lg:grid grid-rows-5 px-20 min-h-screen w-auto bg-transparent relative z-10">
        <img
          className="hidden md:hidden lg:block absolute -z-10 h-full w-full"
          src={BgPlate}
          alt=""
        />
        ...
        <div className="flex row-span-2 flex- bg-transparent max-w-full items-center justify-between">
          <div className="flex flex-row space-x-8  justify-start  mt-32">
            ...
            >
              <BsInstagram size={24} className=" text-white hover:text-white" />
            </button>
            <button
              className="hover:-translate-y-2 transition-all duration-500 ease-in-out"
              onClick={() =>
